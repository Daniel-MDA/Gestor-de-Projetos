...
export default function MembrosAdmin({
  ...
  return (
    <div className="space-y-6">
      {/* Adicionar membro */}
      <div className="bg-white border border-[#e6e2d6] rounded-2xl p-6">
        <h2
          className="text-lg font-medium text-[#1a1815] mb-1"
          style={{ fontFamily: "var(--font-fraunces), serif" }}
        >
          Adicionar membro
        </h2>
        <p className="text-xs text-[#7c7a72] mb-4">
        ...
        <div className="flex flex-col md:flex-row gap-2">
          <div className="flex-1 relative">
            ...
            <input
              ...
              disabled={convidando}
              className="w-full pl-10 pr-3 py-2 text-sm bg-[#fbfaf6] border border-[#d0ccbf] rounded-lg outline-none focus:border-[#1f4e79]"
            />
          </div>
          <select
            value={papelConvite}
            ...
            disabled={convidando}
            className="px-3 py-2 text-sm bg-[#fbfaf6] border border-[#d0ccbf] rounded-lg outline-none focus:border-[#1f4e79]"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 px-4 py-2 text-sm bg-[#1a1815] hover:bg-[#1f4e79] disabled:bg-[#7c7a72] text-white rounded-lg transition-colors"
          >
            {convidando ? (
      ...
      <div className="bg-white border border-[#e6e2d6] rounded-2xl overflow-hidden">
        <div className="px-6 py-4 border-b border-[#e6e2d6] flex items-center justify-between">
          <h2
          ...
          <span className="text-xs text-[#7c7a72] font-mono">
        ...
        <div>
          {membros.map((m) => {
            ...
            return (
              <div
                key={m.usuario_id}
                className="px-6 py-3 flex items-center gap-4 border-b border-[#e6e2d6] last:border-b-0 hover:bg-[#fbfaf6]"
              >
                <div className="w-9 h-9 rounded-full bg-[#e6eef7] flex items-center justify-center shrink-0">
                  <Shield className="w-4 h-4 text-[#1f4e79]" />
                </div>

                <div className="flex-1 min-w-0">
                  <div className="text-sm font-medium text-[#1a1815] truncate">
                    {m.usuario_email}
                    {ehVoce && (
                      <span className="ml-2 text-[10px] font-mono text-[#7c7a72] uppercase">
                        (você)
                      </span>
                    )}
                  </div>
                ...
                {editando ? (
                  <div className="flex items-center gap-1">
                    <select
                      ...
                      className="px-2 py-1 text-xs bg-white border border-[#d0ccbf] rounded outline-none focus:border-[#1f4e79]"
                    >
                      <option value="admin">Administrador</option>
                      <option value="editor">Editor</option>
                      <option value="leitor">Leitor</option>
                    ...
                    <button
                      ...
                      disabled={salvandoEdicao}
                      className="p-1.5 text-[#7c7a72] hover:bg-[#f3f0e8] rounded transition-colors"
                      title="Cancelar"
                    >
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className="p-1.5 text-[#7c7a72] hover:bg-[#f3f0e8] rounded transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                      title={
                        ehUltimoAdmin
                    ...
                    <button
                      ...
                      disabled={ehUltimoAdmin}
                      className="p-1.5 text-[#7c7a72] hover:bg-[#fcdcd6] hover:text-[#8c2c1b] rounded transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                      title={
                        ehUltimoAdmin
      ...
      <div className="text-xs text-[#7c7a72] space-y-1 px-1">
        <div>
        ...
        <div>
          <span className="font-semibold text-[#4b4942]">Leitor:</span> apenas
          visualiza
        </div>
      </div>
    </div>
